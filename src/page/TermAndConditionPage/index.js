    ...
    <DivContact>
      ...
      <DivContent>
        <Text>
          ...
          your use of the Website, and any part of their content and all
          materials appearing on them. By using the Website you confirm that you
          accept these Terms of Use and you agree to comply with them. If you do
        ...
        <Text>
          If you are aged 13 or under, you cannot register for a ShowHub account
          (“Account”) without the permission of your parent/guardian. You need
          to register if you want to play the Fantasy game. You do not need to
        ...
        <Text>
          We aim to update the Website regularly, and may change the content at
          any time. If the need arises, we may suspend access to the Website, or
          close it indefinitely. We will not be liable if for any reason the
          Website is unavailable at any time or for any period. Any of the
        ...
        <Text>
          In registering for an Account, you will be providing personal data to
          the ShowHub. Any personal data which you do submit will be processed
          in accordance with the ShowHub’s Privacy Policy and in accordance with
          relevant data protection legislation including the General Data
          Protection Regulation (“GDPR”) and the Data Protection Act 2018. If
          you are under 18, you can find out more about how we use your personal
          information in our Questions and Answers, which is available here:{' '}
          <a href="/contact">link</a>.
        </Text>
        <Title>EXTERNAL LINKS</Title>
        <Text>
          The Website contains links to other websites and services operated by
          parties independent to the us. We take reasonable precautions in
          ...
          them or any use of your personal data collected by their operators. If
          you decide to access linked websites you do so at your own risk and we
          encourage you to read the privacy statements applicable to each
          specific website.
        </Text>
        <Text>
          If you are under 18, you may need your parent/guardian to help you
        ...
        <Text>
          ...
          Programmes") on the Website but cannot accept any liability for them.
          You are advised to take precautions against such Malicious Programmes,
        ...
        <Text>
          ...
          will co-operate with those authorities by disclosing your identity to
